          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-4">
                Full-stack developer and entertainment technology enthusiast with over a decade of
                experience building innovative web applications. Passionate about creating tools
                that simplify decision-making and enhance the entertainment experience.
              </p>
              <p className="text-muted-foreground mb-4">
                Watch Next Tonight combines my love for cinema and technology, leveraging modern web
                technologies and AI to solve a problem I face every evening: finding the perfect
                thing to watch without spending 30 minutes browsing.
              </p>
